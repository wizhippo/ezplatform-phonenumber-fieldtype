...
namespace Wizhippo\WizhippoPhoneNumberFieldtypeBundle\DependencyInjection;
...
class WizhippoPhoneFieldTypeExtension extends Extension implements PrependExtensionInterface
{
    /**
